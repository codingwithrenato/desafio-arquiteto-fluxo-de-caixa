...
/// <summary>
/// Result pattern: comunica sucesso/falha sem usar exceções para fluxo de controle.
/// Torna o caminho de erro explícito na assinatura dos casos de uso (CQRS handlers).
/// </summary>
public class Result
{
